    ...
    public partial class InitialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceItens", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerEmployeeId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    SubTotalAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sales_Employees_SellerEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleItens_Employees_ExecutorEmployeeId",
                        column: x => x.ExecutorEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleItens_Products_ProductId",
                    ...
                    table.ForeignKey(
                        name: "FK_SaleItens_ServiceItens_ServiceItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleItens_ExecutorEmployeeId",
                table: "SaleItens",
                column: "ExecutorEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleItens_ProductId",
                table: "SaleItens",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleItens_ServiceItemId",
                table: "SaleItens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_SellerEmployeeId",
                table: "Sales",
